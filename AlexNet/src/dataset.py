...
def get_dataloaders():
    ...
    # Standard ImageNet-style eval preprocessing (same convention used
    # everywhere, including the proposed model, since it is not a
    ...
    # No weighted sampler — plain shuffling is standard baseline practice
